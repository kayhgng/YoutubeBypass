...
2. **Proxy SwitchyOmega** (افزونه کروم/فایرفاکس)
   - لینک نصب: [https://chrome.google.com/webstore/detail/proxy-switchyomega/padekgcemlokkgogmolocacabgdnahpd](https://chrome.google.com/webstore/detail/proxy-switchyomega/padekgcemlokkgogmolocacabgdnahpd)
